...
## Aturan Pengumpulan
**Note:**  
_Untuk perintah yang dibungkus < > maka perintah tersebut diganti sesuai instruksi yang ada dalam tanda < > tersebut. Contohnya `mkdir <NIM>` menjadi `mkdir H071231001`_
...
- Pindah ke repositori hasil clone dengan perintah berikut
  ```
  cd LAB-PEMROGRAMAN-WEB-05-2024
  ```
